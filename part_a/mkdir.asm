...
printint(int fd, int xx, int base, int sgn)
{
 ...
 304:	0f b6 92 34 06 00 00 	movzbl 0x634(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 440:	75 28                	jne    46a <printf+0x12a>
          s = "(null)";
 442:	be 2b 06 00 00       	mov    $0x62b,%esi
...
free(void *ap)
{
 ...
 4b5:	a1 d8 08 00 00       	mov    0x8d8,%eax
 ...
 4f1:	89 08                	mov    %ecx,(%eax)
  freep = p;
 4f3:	a3 d8 08 00 00       	mov    %eax,0x8d8
}
 4f8:	5b                   	pop    %ebx
 4f9:	5e                   	pop    %esi
 4fa:	5f                   	pop    %edi
...
morecore(uint nu)
{
 ...
 550:	e8 54 ff ff ff       	call   4a9 <free>
  return freep;
 555:	a1 d8 08 00 00       	mov    0x8d8,%eax
...
malloc(uint nbytes)
{
 ...
 579:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 57c:	8b 0d d8 08 00 00    	mov    0x8d8,%ecx
 ...
 588:	eb 4d                	jmp    5d7 <malloc+0x6e>
    base.s.ptr = freep = prevp = &base;
 58a:	c7 05 d8 08 00 00 dc 	movl   $0x8dc,0x8d8
 591:	08 00 00 
 594:	c7 05 dc 08 00 00 dc 	movl   $0x8dc,0x8dc
 59b:	08 00 00 
    base.s.size = 0;
 59e:	c7 05 e0 08 00 00 00 	movl   $0x0,0x8e0
 5a5:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 5a8:	b9 dc 08 00 00       	mov    $0x8dc,%ecx
 ...
 5bb:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 5be:	89 0d d8 08 00 00    	mov    %ecx,0x8d8
      return (void*)(p + 1);
 ...
 5dc:	73 d1                	jae    5af <malloc+0x46>
    if(p == freep)
 5de:	39 05 d8 08 00 00    	cmp    %eax,0x8d8
