...
main(int argc, char *argv[])
{
  ...
  34:	e8 50 02 00 00       	call   289 <symlink>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 2ef:	0f b6 92 18 06 00 00 	movzbl 0x618(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 42b:	75 28                	jne    455 <printf+0x12a>
          s = "(null)";
 42d:	be 0e 06 00 00       	mov    $0x60e,%esi
...
free(void *ap)
{
 ...
 4dc:	89 08                	mov    %ecx,(%eax)
  freep = p;
 4de:	a3 b4 08 00 00       	mov    %eax,0x8b4
}
 4e3:	5b                   	pop    %ebx
 4e4:	5e                   	pop    %esi
 4e5:	5f                   	pop    %edi
...
morecore(uint nu)
{
 ...
 53b:	e8 54 ff ff ff       	call   494 <free>
  return freep;
 540:	a1 b4 08 00 00       	mov    0x8b4,%eax
...
malloc(uint nbytes)
{
 ...
 564:	83 c3 01             	add    $0x1,%ebx
  if((prevp = freep) == 0){
 567:	8b 0d b4 08 00 00    	mov    0x8b4,%ecx
 ...
 573:	eb 4d                	jmp    5c2 <malloc+0x6e>
    base.s.ptr = freep = prevp = &base;
 575:	c7 05 b4 08 00 00 b8 	movl   $0x8b8,0x8b4
 57c:	08 00 00 
 57f:	c7 05 b8 08 00 00 b8 	movl   $0x8b8,0x8b8
 586:	08 00 00 
    base.s.size = 0;
 589:	c7 05 bc 08 00 00 00 	movl   $0x0,0x8bc
 590:	00 00 00 
    base.s.ptr = freep = prevp = &base;
 593:	b9 b8 08 00 00       	mov    $0x8b8,%ecx
 ...
 5a6:	89 58 04             	mov    %ebx,0x4(%eax)
      ...
      freep = prevp;
 5a9:	89 0d b4 08 00 00    	mov    %ecx,0x8b4
      return (void*)(p + 1);
 ...
 5c7:	73 d1                	jae    59a <malloc+0x46>
    if(p == freep)
 5c9:	39 05 b4 08 00 00    	cmp    %eax,0x8b4
